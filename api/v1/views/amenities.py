#!/usr/bin/python3
"""Defines the amenities view for the API."""
...
def post_amenity():
    """Creates the new Amenity and returns it with the status code 201"""
...
def put_amenity(amenity_id):
    """Updates the Amenity object and returns it with the status code 200"""
    obj = storage.get(Amenity, amenity_id)
    if not obj:
        abort(404)
