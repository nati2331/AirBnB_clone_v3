#!/usr/bin/python3
"""Defines the TestStateDocs classes"""
...
class TestStateDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_test_state(self):
        """Checks if tests/test_models/test_state.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_state_module_docstring(self):
        """Checks for the state.py module docstring"""
    ...
    def test_state_class_docstring(self):
        """Checks for the State class docstring"""
        self.assertIsNot(State.__doc__, None,
    ...
    def test_state_func_docstrings(self):
        """Checks for the presence of docstrings in State methods"""
