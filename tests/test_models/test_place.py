#!/usr/bin/python3
"""Defines the TestPlaceDocs classes"""
...
class TestPlaceDocs(unittest.TestCase):
    """Checks if the documentation and style of Place class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_place(self):
        """Checks if models/place.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_place(self):
        """Checks if tests/test_models/test_place.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_place_class_docstring(self):
        """Checks for the Place class docstring"""
        self.assertIsNot(Place.__doc__, None,
    ...
    def test_place_func_docstrings(self):
        """Checks for the presence of docstrings in Place methods"""
...
class TestPlace(unittest.TestCase):
    ...
    def test_city_id_attr(self):
        """Checks if Place has attr city_id, and it's an empty string"""
        place = Place()
    ...
    def test_user_id_attr(self):
        """Checks if Place has attr user_id, and it's an empty string"""
        place = Place()
    ...
    def test_name_attr(self):
        """Checks if Place has attr name, and it's an empty string"""
        place = Place()
    ...
    def test_description_attr(self):
        """Checks if Place has attr description, and it's an empty string"""
        place = Place()
    ...
    def test_number_bathrooms_attr(self):
        """Chkecks if Place has attr number_bathrooms, and it's an int == 0"""
        place = Place()
    ...
    def test_max_guest_attr(self):
        """Checks if Place has attr max_guest, and it's an int == 0"""
        place = Place()
    ...
    def test_price_by_night_attr(self):
        """Checks if Place has attr price_by_night, and it's an int == 0"""
        place = Place()
    ...
    def test_latitude_attr(self):
        """Checks if Place has attr latitude, and it's a float == 0.0"""
        place = Place()
    ...
    def test_longitude_attr(self):
        """Checks if Place has attr longitude, and it's a float == 0.0"""
        place = Place()
    ...
    def test_amenity_ids_attr(self):
        """Checks if Place has attr amenity_ids, and it's an empty list"""
        place = Place()
    ...
    def test_to_dict_values(self):
        """Checks values in dict returned from to_dict are correct"""
