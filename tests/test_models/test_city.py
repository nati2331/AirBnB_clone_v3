...
class TestCityDocs(unittest.TestCase):
    """Checks the documentation and style of City class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_city(self):
        """Checks if models/city.py adheres to PEP8."""
    ...
    def test_pep8_conformance_test_city(self):
        """Checks if the tests/test_models/test_city.py adheres to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_city_module_docstring(self):
        """Test for the presence of city.py module docstring"""
    ...
    def test_city_class_docstring(self):
        """Checks the presence of City class docstring"""
        self.assertIsNot(City.__doc__, None,
...
class TestCity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Checks if City has attribute name, and it's an empty string"""
        city = City()
    ...
    def test_state_id_attr(self):
        """Checks if City has attribute state_id, and it's an empty string"""
        city = City()
