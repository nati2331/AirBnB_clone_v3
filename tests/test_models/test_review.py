#!/usr/bin/python3
"""Defines the TestReviewDocs classes"""
...
class TestReviewDocs(unittest.TestCase):
    """Checks the documentation and style of Review class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_review(self):
        """Checks if models/review.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_review(self):
        """Checks if tests/test_models/test_review.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_review_module_docstring(self):
        """Checks if the review.py module docstring"""
    ...
    def test_review_class_docstring(self):
        """Checks if the Review class docstring"""
        self.assertIsNot(Review.__doc__, None,
    ...
    def test_review_func_docstrings(self):
        """Checks if the presence of docstrings in Review methods"""
...
class TestReview(unittest.TestCase):
    ...
    def test_place_id_attr(self):
        """Checks if Review has attr place_id, and it's an empty string"""
        review = Review()
    ...
    def test_user_id_attr(self):
        """Checks if Review has attr user_id, and it's an empty string"""
        review = Review()
    ...
    def test_text_attr(self):
        """Checks if Review has attr text, and it's an empty string"""
        review = Review()
