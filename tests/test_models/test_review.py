...
class TestReviewDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_review(self):
        """Checks if review.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_review(self):
        """Checks if test_review.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_review_module_docstring(self):
        """Checks for the review.py docstring"""
    ...
    def test_review_class_docstring(self):
        """Checks for the Review class docstring"""
        self.assertIsNot(Review.__doc__, None,
    ...
    def test_review_func_docstrings(self):
        """Checks the presence of docstrings in Review"""
...
class TestReview(unittest.TestCase):
    ...
    def test_place_id_attr(self):
        """Checks Review has attr place_id"""
        review = Review()
    ...
    def test_user_id_attr(self):
        """Checks Review has attr user_id"""
        review = Review()
