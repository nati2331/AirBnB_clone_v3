...
class TestDBStorageDocs(unittest.TestCase):
    """Checks the documentation of DBStorage class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_db_storage(self):
        """Checks if db_storage.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_db_storage(self):
        """Checks test_db_storage.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
...
test_db_storage.py'])
    ...
    def test_db_storage_module_docstring(self):
        """Checks the db_storage.py docstring"""
    ...
    def test_db_storage_class_docstring(self):
        """Checks the DBStorage class docstring"""
    ...
    def test_dbs_func_docstrings(self):
        """Checks the presence of docstrings in DBStorage methods"""
...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        """Checks if get returns specific object"""
