...
class TestAmenityDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_amenity(self):
        """Checks models/amenity.py conforms to PEP8."""
    ...
    def test_pep8_conformance_test_amenity(self):
        """Checks tests/test_models/test_amenity.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_amenity_module_docstring(self):
        """Checks for the amenity.py module docstring"""
    ...
    def test_amenity_class_docstring(self):
        """Checks the Amenity class docstring"""
        self.assertIsNot(Amenity.__doc__, None,
    ...
    def test_amenity_func_docstrings(self):
        """Checks the presence of docstrings in Amenity methods"""
...
class TestAmenity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Checks Amenity has attribute name"""
        amenity = Amenity()
    ...
    def test_name_attr_db(self):
        """Checks DBStorage name"""
        amenity = Amenity()
        self.assertTrue(hasattr(Amenity, "name"))
        self.assertIsInstance(Amenity.name, InstrumentedAttribute)

    def test_to_dict_creates_dict(self):
        """test to_dict method creates a list with attrs"""
        am = Amenity()
        new_d = am.to_dict()
